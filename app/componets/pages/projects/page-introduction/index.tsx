...
export const PageIntroduction = () => {
  return(
    <section className="w-full h-[420px} lg:h-[530px] bg-hero-image bg-cover bg-center bg-no-repeat flex-col items-center justify-center">
      <SectionTitle 
      subtitle="projetos" 
      title="Meus Projetos"
      ...
      <div className="flex flex-col items-center">
        ...
        <Link
        href="/"> 
        <HiArrowNarrowLeft size={20}/> Voltar para Home 
        </Link>
      </div>
    </section>
  )
